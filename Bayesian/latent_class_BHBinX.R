...
niters <- 344632
nthin <- 92
draws_Z <- array(NA, dim = c(I, M, C, k_z, nchains, niters/nthin)) # latent, don't track
...
save(mcmc_out, file = '../mcmc_draws/mcmc_BHBinX.Rdata')
...
ggsave('../figs/haplo_tern_BHBinX.png')
