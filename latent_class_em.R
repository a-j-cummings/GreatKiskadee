...
rand <- LatentClassEM(haplo, preproc, 3, tol = 1)
rand
half <- LatentClassEM(haplo, preproc, 3, tol = 0.15)
half
tenth <- LatentClassEM(haplo, preproc, 3, tol = 1e-1)
tenth
hundreth <- LatentClassEM(haplo, preproc, 3, tol = 0.05)
hundreth
